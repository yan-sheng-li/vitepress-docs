import{_ as i,c as a,o as n,aj as l}from"./chunks/framework.VtnL2jmu.js";const E=JSON.parse('{"title":"gitea自定义issue模板","description":"","frontmatter":{},"headers":[],"relativePath":"git/gitea自定义issue模板.md","filePath":"git/gitea自定义issue模板.md"}'),e={name:"git/gitea自定义issue模板.md"};function t(h,s,p,k,d,g){return n(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="gitea自定义issue模板" tabindex="-1">gitea自定义issue模板 <a class="header-anchor" href="#gitea自定义issue模板" aria-label="Permalink to “gitea自定义issue模板”">​</a></h1><p>以下是适用于 Gitea 的三个常用 issue 模板，分别是：</p><ol><li>🐞 Bug 报告（bug.md）</li><li>🌟 功能请求（feature.md）</li><li>❓ 使用咨询 / 问题反馈（question.md）</li></ol><p>将它们放在你的仓库目录下的 <code>.gitea/ISSUE_TEMPLATE/</code> 文件夹中。</p><hr><h3 id="✅-gitea-issue-template-bug-md" tabindex="-1">✅ <code>.gitea/ISSUE_TEMPLATE/bug.md</code> <a class="header-anchor" href="#✅-gitea-issue-template-bug-md" aria-label="Permalink to “✅ .gitea/ISSUE_TEMPLATE/bug.md”">​</a></h3><div class="language-markdown"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">---</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">name: 🐞 Bug 报告</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">about: 提交一个 bug 或系统异常问题</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">title: &quot;[</span><span style="--shiki-light:#032F62;--shiki-light-text-decoration:underline;--shiki-dark:#DBEDFF;--shiki-dark-text-decoration:underline;">Bug</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]: &quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">labels: bug</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">assignees: &#39;&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 日志中是否有报错（粘贴关键日志）：</span></span></code></pre></div><hr><h3 id="✅-gitea-issue-template-feature-md" tabindex="-1">✅ <code>.gitea/ISSUE_TEMPLATE/feature.md</code> <a class="header-anchor" href="#✅-gitea-issue-template-feature-md" aria-label="Permalink to “✅ .gitea/ISSUE_TEMPLATE/feature.md”">​</a></h3><div class="language-markdown"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">---</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">name: 🌟 功能请求</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">about: 提出一个新功能、增强或建议</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">title: &quot;[</span><span style="--shiki-light:#032F62;--shiki-light-text-decoration:underline;--shiki-dark:#DBEDFF;--shiki-dark-text-decoration:underline;">Feature</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]: &quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">labels: enhancement</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">assignees: &#39;&#39;</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">---</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">你是否有参考链接、其他平台的做法？</span></span></code></pre></div><hr><h3 id="✅-gitea-issue-template-question-md" tabindex="-1">✅ <code>.gitea/ISSUE_TEMPLATE/question.md</code> <a class="header-anchor" href="#✅-gitea-issue-template-question-md" aria-label="Permalink to “✅ .gitea/ISSUE_TEMPLATE/question.md”">​</a></h3><div class="language-markdown"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">---</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">name: ❓ 使用咨询 / 问题反馈</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">about: 提问或反馈使用中遇到的问题（非 bug）</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">title: &quot;[</span><span style="--shiki-light:#032F62;--shiki-light-text-decoration:underline;--shiki-dark:#DBEDFF;--shiki-dark-text-decoration:underline;">Question</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]: &quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">labels: question</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">assignees: &#39;&#39;</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">---</span></span>
<span class="line"></span>
...
<span class="line"><span>        └── question.md</span></span></code></pre></div>`,16)])])}const o=i(e,[["render",t]]);export{E as __pageData,o as default};
